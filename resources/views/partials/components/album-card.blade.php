...
<div class="card mb-3 mx-0 mx-sm-5 mx-md-auto">
    ...
    <div class="card-body pb-0">
        <h5 class="card-title mb-0">{{ $title }}<small
                class="card-text text-muted mb-0">&nbsp;&#8212;&nbsp;{{ $description }}</small></h5>
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item">
                <iframe style="border: 0; width: 100%; height: 42px;"
                    src="https://bandcamp.com/EmbeddedPlayer/{{ $bandcamp_id_type }}={{ $bandcamp_track_id }}/size=small/bgcol=ffffff/linkcol=177e89/transparent=true/"
